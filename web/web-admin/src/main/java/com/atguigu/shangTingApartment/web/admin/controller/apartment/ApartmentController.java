...
public class ApartmentController {
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo apartmentDetailVo = apartmentInfoService.queryDetailById(id);
    ...
    public Result updateReleaseStatusById(@RequestParam Long id, @RequestParam ReleaseStatus status) {
        ...
        wrapper.eq(ApartmentInfo::getId,id).set(ApartmentInfo::getIsRelease,status);
        boolean updated = apartmentInfoService.update(wrapper);
